...
f_change = Entry(frame_change) #entry на что меняем прошлое имя в бд
...
btn_update = ttk.Button(frame_change, text="Обновить БД", command=refresh)
but_change = Button(frame_change, text='Изменить', command=changeDB)
btn_reference = ttk.Button(frame_change, text="Справка", command=back.reference)
...
btn_update.grid(row=1, column=3, columnspan=2, sticky='w', padx=10, pady=10)
